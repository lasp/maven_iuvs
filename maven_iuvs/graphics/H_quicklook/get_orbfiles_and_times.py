...
def get_orbfiles_and_times(orbno):
    ...
    fuvfilenames=find_files(pattern='*-orbit'+str(orbno).zfill(5)+'*fuv*')
    echfilenames=find_files(pattern='*-orbit'+str(orbno).zfill(5)+'*ech*')
