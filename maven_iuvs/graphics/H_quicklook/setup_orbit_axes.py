...
def setup_orbit_axes(fig, orbit_ax, orbit_coords, orbtimedict=None, orbit_bbox=None, panel_x_start_frac=None):
    ...
    if orbtimedict!=None:
        ...
        from maven_iuvs.graphics.maven_orbit_image import maven_orbit_image
